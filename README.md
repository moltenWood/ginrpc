...
[![Go Report Card](https://goreportcard.com/badge/github.com/molten/ginrpc)](https://goreportcard.com/report/github.com/molten/ginrpc)
[![codecov](https://codecov.io/gh/xxjwxc/ginrpc/branch/master/graph/badge.svg)](https://codecov.io/gh/xxjwxc/ginrpc)
[![GoDoc](https://godoc.org/github.com/molten/ginrpc?status.svg)](https://godoc.org/github.com/molten/ginrpc)
...
- Support [swagger](http://editor.swagger.io/) [MORE](https://github.com/molten/gmsec)
- Support [markdown/mindoc](https://www.iminho.me/) [MORE](https://github.com/molten/gmsec)
- Support call before and after deal(`ginrpc.WithBeforeAfter`)

- [DEMO](https://github.com/molten/gmsec)

## Installing
- go mod:
```
go get -u github.com/molten/ginrpc@master
```
...
import (
	...
	"github.com/molten/ginrpc/public/mydoc/myswagger" // swagger 支持

	"github.com/gin-gonic/gin"
	"github.com/molten/ginrpc"
	"github.com/molten/ginrpc/api"
)
...
### 3. Parameter description
	...
	[more>>](https://godoc.org/github.com/molten/ginrpc)
...
```
- [more >>>](https://github.com/molten/gmsec)
...
### coding address:[ginprc](https://github.com/molten/ginrpc) Please give star support